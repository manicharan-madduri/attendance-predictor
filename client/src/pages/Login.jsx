    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#07070f] p-4">
      ...
      >
        ...
        >
          ...
          <h1 className="text-4xl font-black text-white tracking-tight">AttendCalc</h1>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-4">
            {[
              ...
              { key: 'password', label: 'Password', type: 'password', placeholder: '••••••••', Icon: MdLock },
            ].map(({ key, label, type, placeholder, Icon }, i) => (
              <motion.div
                key={key}
